...
#' @param qc_cellcount_cutoff If an image has between 1 and `qc_cellcount_cutoff` "to" cells, or between 1 and `qc_cellcount_cutoff` "from" cells, the image is excluded from the calculation of the spatial summary function. (Similar to SpaceANOVA's `Hard_ths` parameter.) If there are 1 or more "to" cells and 0 "from" cells, the spatial summary function is considered to be 0 at all radii.
