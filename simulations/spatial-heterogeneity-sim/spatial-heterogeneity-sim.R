...
g1 <- rpois(nPatients/2, sigmab) #Group 1 is the treatment group
g2 <- rpois(nPatients/2, sigmab + deltab ) #Group 2 is the control group
...
#For the prediction, use \hat{L}_{AT}(r) from patients 5 and 59
...
#-------------- Get confidence band for E[Y|X] for a TRT patient (stroma region only) ---------------------------------
